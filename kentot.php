...
-----------------------------------------";
echo $ciyan . "
 ▌│█║▌║▌ http://www.maqlodzgn.blogspot.com";
echo $ciyan . "
-----------------------------------------" . $grey . "
...
";
                ...
                $opt = ['https://www.google.co.id', 'https://www.youtube.com', 'https://www.google.com', 'https://maqlodzgn.blogspot.com', 'https://www.yahoo.com', 'https://www.yandex.ru', 'https://www.wikipedia.org'];
                echo $fgreen . "
[#] Mengirim ... 
";
                for ($i = 1;$i < $b + 1;++$i) {
